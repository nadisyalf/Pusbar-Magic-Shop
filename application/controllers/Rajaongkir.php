...
{
    private $api_key ='f95419568adf9a7f61e4b4efe081e80a';
    ...
    public function paket()
    {
        ...
        echo "cURL Error #:" . $err;
            ...
            foreach ($data_paket as $key => $value) {
                echo "<option value='" . $value['service']. "' . ongkir='" . $value['cost'][0]['value']. "' estimasi= '" .$value['cost'][0]['etd']." Days '>"; 
                echo $value['service'] ." | Rp. " .  $value['cost'][0]['value']. " | ". $value['cost'][0]['etd']. " Days";
                echo "</option>";
            }
        }
    }
