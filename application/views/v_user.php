<div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <button data-toggle="modal" data-target="#add" type="button" class="btn btn-primary btn-xs" ><i class="fas fa-plus"></i> Add
                    </button>
                    </div>
                    <!-- /.card-tools -->
                </div>
    ...
    <div class="modal fade" id="edit<?= $value->id_user ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="form-group">
                    <label>Nama Lengkap</label>
                    <input type="text" name="nama_user" value="<?= $value->nama_user ?>" class="form-control"  placeholder="Nama Lengkap" required>
                </div>
