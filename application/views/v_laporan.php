    ...
    <div class="card card-warning">
        ...
        <?php echo form_open('laporan/lap_bulanan',) ?>
                ...
                <div class="col-sm-12">
                    <!-- text input -->
                    <div class="form-group">
                        <button type="submit" target="-_blank" class="btn btn-warning btn-block"> <i class="fa fa-print"> Cetak Loporan </i></button>
                    </div>
                </div>
                <?php echo form_close() ?>
                </div>
    ...
    <div class="card card-success">
        ...
        <?php echo form_open('laporan/lap_tahunan',) ?>
                ...
                <div class="col-sm-12">
                    <!-- text input -->
                    <div class="form-group">
                        <button type="submit" target="-_blank" class="btn btn-success btn-block"> <i class="fa fa-print"> Cetak Loporan </i></button>
                    </div>
                </div>
                <?php echo form_close() ?>
                </div>
