...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="<?= base_url()?>" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light"><b> PUSBAR MAGIC SHOP</b></span>
        </a>
            ...
            <li class="nav-item">
                <?php if ($this->session->userdata('email') == "") { ?>
                    <a class="nav-link" href="<?= base_url('pelanggan/login')?>">
                        <div class="brand-text font-weight-light">Login/Register</div>
                    </a>
                <?php }else{ ?>
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <strong> Selamat Datang, <?= $this->session->userdata('nama_pelanggan') ?> !</strong>
                    </a>
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="#">PUSBAR MAGIC SHOP</a></li>
